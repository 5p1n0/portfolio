      ...
      <div className="flex items-center justify-between">
        ...
        >
          <svg width="43" height="64" viewBox="0 0 43 64">
            ...
            <path transform="translate(24.946 6)" d="M-3.446,7.139A2.549,2.549,0,0,1-6,4.6V-3.457A2.549,2.549,0,0,1-3.446-6,2.549,2.549,0,0,1-.891-3.457V4.6A2.549,2.549,0,0,1-3.446,7.139Z" fill="#efefef" />
            <path transform="translate(24.946 56.861)" d="M-3.446,7.139A2.549,2.549,0,0,1-6,4.6V-3.457A2.549,2.549,0,0,1-3.446-6,2.549,2.549,0,0,1-.891-3.457V4.6A2.549,2.549,0,0,1-3.446,7.139Z" fill="#efefef" />
          </svg>
